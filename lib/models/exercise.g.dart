...
const ExerciseSchema = CollectionSchema(
  ...
  links: {
    r'exerciseSets': LinkSchema(
      id: 2090376017383617849,
      name: r'exerciseSets',
...
List<IsarLinkBase<dynamic>> _exerciseGetLinks(Exercise object) {
  return [object.exerciseSets];
}

void _exerciseAttach(IsarCollection<dynamic> col, Id id, Exercise object) {
  object.id = id;
  object.exerciseSets
      .attach(col, col.isar.collection<ExerciseSet>(), r'exerciseSets', id);
}
...
extension ExerciseQueryFilter
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> orderEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'order',
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> orderGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> orderLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> orderBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ExerciseQueryLinks
    on QueryBuilder<Exercise, Exercise, QFilterCondition> {
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> exerciseSets(
      FilterQuery<ExerciseSet> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'exerciseSets');
    });
  }

  QueryBuilder<Exercise, Exercise, QAfterFilterCondition>
      exerciseSetsLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'exerciseSets', length, true, length, true);
    });
  }
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition>
      exerciseSetsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'exerciseSets', 0, true, 0, true);
    });
  }

  QueryBuilder<Exercise, Exercise, QAfterFilterCondition>
      exerciseSetsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'exerciseSets', 0, false, 999999, true);
    });
  }

  QueryBuilder<Exercise, Exercise, QAfterFilterCondition>
      exerciseSetsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'exerciseSets', 0, true, length, include);
    });
  }

  QueryBuilder<Exercise, Exercise, QAfterFilterCondition>
      exerciseSetsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'exerciseSets', length, include, 999999, true);
    });
  }

  QueryBuilder<Exercise, Exercise, QAfterFilterCondition>
      exerciseSetsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'exerciseSets', lower, includeLower, upper, includeUpper);
    });
  }
}
...
extension ExerciseQuerySortBy on QueryBuilder<Exercise, Exercise, QSortBy> {
  ...
  QueryBuilder<Exercise, Exercise, QAfterSortBy> sortByOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'order', Sort.asc);
    });
  }

  QueryBuilder<Exercise, Exercise, QAfterSortBy> sortByOrderDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ExerciseQuerySortThenBy
  ...
  QueryBuilder<Exercise, Exercise, QAfterSortBy> thenByOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'order', Sort.asc);
    });
  }

  QueryBuilder<Exercise, Exercise, QAfterSortBy> thenByOrderDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'order', Sort.desc);
    });
  }
...
extension ExerciseQueryWhereDistinct
  ...
  QueryBuilder<Exercise, Exercise, QDistinct> distinctByOrder() {
    return QueryBuilder.apply(this, (query) {
...
extension ExerciseQueryProperty
  ...
  QueryBuilder<Exercise, int, QQueryOperations> orderProperty() {
    return QueryBuilder.apply(this, (query) {
